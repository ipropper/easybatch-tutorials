...
We will reuse the same application developed in the Hello world tutorial but with a huge tweets data source:
...
Sometimes, it is possible to split the data source into multiple slices:
